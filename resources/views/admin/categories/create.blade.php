    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.categories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('category_color') ? 'is-invalid' : '' }} my-colorpicker1" type="text" name="category_color" id="category_color" value="{{ old('category_color') }}" step="1">
