                ...
                <table class=" table table-bordered table-striped table-hover datatable datatable-Specialist">
                    <thead>
                        <tr>
                            ...
                            <th>
                                {{ trans('cruds.specialist.fields.recurring_day') }}
                            </th>
                            <th>
                    ...
                    <tbody>
                        @foreach($specialists as $key => $specialist)
                            <tr data-entry-id="{{ $specialist->id }}">
                                ...
                                <td>
                                    {{ $specialist->category->amount ?? '' }}
                                </td>
                                <td>
                                    @if($specialist->image)
                                        <a href="{{ $specialist->image->getUrl() }}" target="_blank">
                                            <img src="{{ $specialist->image->getUrl('thumb') }}" width="50px" height="50px">
                                        </a>
                                    @endif
                                </td>
                                <td>
                         ...
                         {{--       <td>
                                    {{ App\Specialist::RECURRING_DAY_RADIO[$specialist->recurring_day] ?? '' }}
                                </td> --}}
                                <td> 
