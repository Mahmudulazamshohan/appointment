...
<head>
	...
	<title>Just Got Reservation</title>
	<style>
		body{
...
<center>
	<div style="max-width: 600px;padding: 0 18px 9px 18px;margin-top: 43px;">
		...
		<div style="text-align: left; margin-top: 50px;">
			<div>
				<h1 style="font-size:18px">Přijetí Vaší rezervace.</h1>
			...
			<div>
				...
				<p>Vaši rezervaci právě zpracováváme a o jejím potvrzení Vás budeme dále informovat na této e-mailové adrese.</p>
			</div>
			<div>
				<p>Srdečně,<br>
